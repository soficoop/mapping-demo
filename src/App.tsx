...
export function App() {
  ...
  useEffect(() => {
    ...
    // Unmount after 1.7s (500ms transition)
  ...
  return (
    <>
      {showSplash && (
        <div
          className={`fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-gradient-to-tr from-amber-50/90 via-white to-orange-50/90 text-slate-900 transition-all duration-500 ease-in-out dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 dark:text-white ${
            splashFade
                ...
                <div className="space-y-4">
                  ...
                  {areas.length === 0 ? (
                    <div className="rounded-lg border border-dashed border-slate-200 p-4 text-center text-slate-400 dark:border-slate-800">
                      No custom areas drawn yet. Draw an area polygon on the
                      "Draw Tools" tab, place some POIs inside it, and view its
                      statistics here!
                    </div>
                  ) : (
                    <div className="space-y-4">
